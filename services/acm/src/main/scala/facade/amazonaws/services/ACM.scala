...
package acm {
  ...
  object CertificateTransparencyLoggingPreference {
    @inline def ENABLED = "ENABLED".asInstanceOf[CertificateTransparencyLoggingPreference]
    @inline def DISABLED = "DISABLED".asInstanceOf[CertificateTransparencyLoggingPreference]
  ...
  object CertificateType {
    @inline def IMPORTED = "IMPORTED".asInstanceOf[CertificateType]
    @inline def AMAZON_ISSUED = "AMAZON_ISSUED".asInstanceOf[CertificateType]
    @inline def PRIVATE = "PRIVATE".asInstanceOf[CertificateType]
  ...
  object DomainStatus {
    ...
    @inline def SUCCESS = "SUCCESS".asInstanceOf[DomainStatus]
  ...
  object ExtendedKeyUsageName {
    @inline def TLS_WEB_SERVER_AUTHENTICATION = "TLS_WEB_SERVER_AUTHENTICATION".asInstanceOf[ExtendedKeyUsageName]
    @inline def TLS_WEB_CLIENT_AUTHENTICATION = "TLS_WEB_CLIENT_AUTHENTICATION".asInstanceOf[ExtendedKeyUsageName]
    @inline def CODE_SIGNING = "CODE_SIGNING".asInstanceOf[ExtendedKeyUsageName]
    @inline def EMAIL_PROTECTION = "EMAIL_PROTECTION".asInstanceOf[ExtendedKeyUsageName]
    @inline def TIME_STAMPING = "TIME_STAMPING".asInstanceOf[ExtendedKeyUsageName]
    @inline def OCSP_SIGNING = "OCSP_SIGNING".asInstanceOf[ExtendedKeyUsageName]
    @inline def IPSEC_END_SYSTEM = "IPSEC_END_SYSTEM".asInstanceOf[ExtendedKeyUsageName]
    @inline def IPSEC_TUNNEL = "IPSEC_TUNNEL".asInstanceOf[ExtendedKeyUsageName]
    @inline def IPSEC_USER = "IPSEC_USER".asInstanceOf[ExtendedKeyUsageName]
    @inline def ANY = "ANY".asInstanceOf[ExtendedKeyUsageName]
    @inline def NONE = "NONE".asInstanceOf[ExtendedKeyUsageName]
    @inline def CUSTOM = "CUSTOM".asInstanceOf[ExtendedKeyUsageName]
  ...
  object FailureReason {
    @inline def NO_AVAILABLE_CONTACTS = "NO_AVAILABLE_CONTACTS".asInstanceOf[FailureReason]
    @inline def ADDITIONAL_VERIFICATION_REQUIRED = "ADDITIONAL_VERIFICATION_REQUIRED".asInstanceOf[FailureReason]
    @inline def DOMAIN_NOT_ALLOWED = "DOMAIN_NOT_ALLOWED".asInstanceOf[FailureReason]
    @inline def INVALID_PUBLIC_DOMAIN = "INVALID_PUBLIC_DOMAIN".asInstanceOf[FailureReason]
    @inline def DOMAIN_VALIDATION_DENIED = "DOMAIN_VALIDATION_DENIED".asInstanceOf[FailureReason]
    @inline def CAA_ERROR = "CAA_ERROR".asInstanceOf[FailureReason]
    @inline def PCA_LIMIT_EXCEEDED = "PCA_LIMIT_EXCEEDED".asInstanceOf[FailureReason]
    @inline def PCA_INVALID_ARN = "PCA_INVALID_ARN".asInstanceOf[FailureReason]
    @inline def PCA_INVALID_STATE = "PCA_INVALID_STATE".asInstanceOf[FailureReason]
    @inline def PCA_REQUEST_FAILED = "PCA_REQUEST_FAILED".asInstanceOf[FailureReason]
    @inline def PCA_NAME_CONSTRAINTS_VALIDATION = "PCA_NAME_CONSTRAINTS_VALIDATION".asInstanceOf[FailureReason]
    @inline def PCA_RESOURCE_NOT_FOUND = "PCA_RESOURCE_NOT_FOUND".asInstanceOf[FailureReason]
    @inline def PCA_INVALID_ARGS = "PCA_INVALID_ARGS".asInstanceOf[FailureReason]
    @inline def PCA_INVALID_DURATION = "PCA_INVALID_DURATION".asInstanceOf[FailureReason]
    @inline def PCA_ACCESS_DENIED = "PCA_ACCESS_DENIED".asInstanceOf[FailureReason]
  ...
  object KeyAlgorithm {
    ...
    @inline def RSA_1024 = "RSA_1024".asInstanceOf[KeyAlgorithm]
    ...
    @inline def EC_secp521r1 = "EC_secp521r1".asInstanceOf[KeyAlgorithm]
  ...
  object KeyUsageName {
    @inline def DIGITAL_SIGNATURE = "DIGITAL_SIGNATURE".asInstanceOf[KeyUsageName]
    @inline def NON_REPUDIATION = "NON_REPUDIATION".asInstanceOf[KeyUsageName]
    @inline def KEY_ENCIPHERMENT = "KEY_ENCIPHERMENT".asInstanceOf[KeyUsageName]
    @inline def DATA_ENCIPHERMENT = "DATA_ENCIPHERMENT".asInstanceOf[KeyUsageName]
    @inline def KEY_AGREEMENT = "KEY_AGREEMENT".asInstanceOf[KeyUsageName]
    @inline def CERTIFICATE_SIGNING = "CERTIFICATE_SIGNING".asInstanceOf[KeyUsageName]
    @inline def CRL_SIGNING = "CRL_SIGNING".asInstanceOf[KeyUsageName]
    @inline def ENCIPHER_ONLY = "ENCIPHER_ONLY".asInstanceOf[KeyUsageName]
    @inline def DECIPHER_ONLY = "DECIPHER_ONLY".asInstanceOf[KeyUsageName]
    @inline def ANY = "ANY".asInstanceOf[KeyUsageName]
    @inline def CUSTOM = "CUSTOM".asInstanceOf[KeyUsageName]
  ...
  object RenewalEligibility {
    @inline def ELIGIBLE = "ELIGIBLE".asInstanceOf[RenewalEligibility]
    @inline def INELIGIBLE = "INELIGIBLE".asInstanceOf[RenewalEligibility]
  ...
  object RenewalStatus {
    @inline def PENDING_AUTO_RENEWAL = "PENDING_AUTO_RENEWAL".asInstanceOf[RenewalStatus]
    @inline def PENDING_VALIDATION = "PENDING_VALIDATION".asInstanceOf[RenewalStatus]
  ...
  object RevocationReason {
    ...
    @inline def CA_COMPROMISE = "CA_COMPROMISE".asInstanceOf[RevocationReason]
    @inline def AFFILIATION_CHANGED = "AFFILIATION_CHANGED".asInstanceOf[RevocationReason]
    @inline def SUPERCEDED = "SUPERCEDED".asInstanceOf[RevocationReason]
    @inline def CESSATION_OF_OPERATION = "CESSATION_OF_OPERATION".asInstanceOf[RevocationReason]
    @inline def CERTIFICATE_HOLD = "CERTIFICATE_HOLD".asInstanceOf[RevocationReason]
    @inline def REMOVE_FROM_CRL = "REMOVE_FROM_CRL".asInstanceOf[RevocationReason]
  ...
  object ValidationMethod {
    @inline def EMAIL = "EMAIL".asInstanceOf[ValidationMethod]
    @inline def DNS = "DNS".asInstanceOf[ValidationMethod]
