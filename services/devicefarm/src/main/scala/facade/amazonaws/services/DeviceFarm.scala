...
package devicefarm {
  ...
  object ArtifactCategory {
    @inline def SCREENSHOT = "SCREENSHOT".asInstanceOf[ArtifactCategory]
    @inline def FILE = "FILE".asInstanceOf[ArtifactCategory]
    @inline def LOG = "LOG".asInstanceOf[ArtifactCategory]
  ...
  object ArtifactType {
    @inline def UNKNOWN = "UNKNOWN".asInstanceOf[ArtifactType]
    @inline def SCREENSHOT = "SCREENSHOT".asInstanceOf[ArtifactType]
    @inline def DEVICE_LOG = "DEVICE_LOG".asInstanceOf[ArtifactType]
    @inline def MESSAGE_LOG = "MESSAGE_LOG".asInstanceOf[ArtifactType]
    @inline def VIDEO_LOG = "VIDEO_LOG".asInstanceOf[ArtifactType]
    @inline def RESULT_LOG = "RESULT_LOG".asInstanceOf[ArtifactType]
    @inline def SERVICE_LOG = "SERVICE_LOG".asInstanceOf[ArtifactType]
    @inline def WEBKIT_LOG = "WEBKIT_LOG".asInstanceOf[ArtifactType]
    @inline def INSTRUMENTATION_OUTPUT = "INSTRUMENTATION_OUTPUT".asInstanceOf[ArtifactType]
    @inline def EXERCISER_MONKEY_OUTPUT = "EXERCISER_MONKEY_OUTPUT".asInstanceOf[ArtifactType]
    @inline def CALABASH_JSON_OUTPUT = "CALABASH_JSON_OUTPUT".asInstanceOf[ArtifactType]
    @inline def CALABASH_PRETTY_OUTPUT = "CALABASH_PRETTY_OUTPUT".asInstanceOf[ArtifactType]
    @inline def CALABASH_STANDARD_OUTPUT = "CALABASH_STANDARD_OUTPUT".asInstanceOf[ArtifactType]
    @inline def CALABASH_JAVA_XML_OUTPUT = "CALABASH_JAVA_XML_OUTPUT".asInstanceOf[ArtifactType]
    @inline def AUTOMATION_OUTPUT = "AUTOMATION_OUTPUT".asInstanceOf[ArtifactType]
    @inline def APPIUM_SERVER_OUTPUT = "APPIUM_SERVER_OUTPUT".asInstanceOf[ArtifactType]
    @inline def APPIUM_JAVA_OUTPUT = "APPIUM_JAVA_OUTPUT".asInstanceOf[ArtifactType]
    @inline def APPIUM_JAVA_XML_OUTPUT = "APPIUM_JAVA_XML_OUTPUT".asInstanceOf[ArtifactType]
    @inline def APPIUM_PYTHON_OUTPUT = "APPIUM_PYTHON_OUTPUT".asInstanceOf[ArtifactType]
    @inline def APPIUM_PYTHON_XML_OUTPUT = "APPIUM_PYTHON_XML_OUTPUT".asInstanceOf[ArtifactType]
    @inline def EXPLORER_EVENT_LOG = "EXPLORER_EVENT_LOG".asInstanceOf[ArtifactType]
    @inline def EXPLORER_SUMMARY_LOG = "EXPLORER_SUMMARY_LOG".asInstanceOf[ArtifactType]
    @inline def APPLICATION_CRASH_REPORT = "APPLICATION_CRASH_REPORT".asInstanceOf[ArtifactType]
    @inline def XCTEST_LOG = "XCTEST_LOG".asInstanceOf[ArtifactType]
    @inline def VIDEO = "VIDEO".asInstanceOf[ArtifactType]
    @inline def CUSTOMER_ARTIFACT = "CUSTOMER_ARTIFACT".asInstanceOf[ArtifactType]
    @inline def CUSTOMER_ARTIFACT_LOG = "CUSTOMER_ARTIFACT_LOG".asInstanceOf[ArtifactType]
    @inline def TESTSPEC_OUTPUT = "TESTSPEC_OUTPUT".asInstanceOf[ArtifactType]
  ...
  object BillingMethod {
    @inline def METERED = "METERED".asInstanceOf[BillingMethod]
    @inline def UNMETERED = "UNMETERED".asInstanceOf[BillingMethod]
  ...
  object DeviceAttribute {
    @inline def ARN = "ARN".asInstanceOf[DeviceAttribute]
    @inline def PLATFORM = "PLATFORM".asInstanceOf[DeviceAttribute]
    @inline def FORM_FACTOR = "FORM_FACTOR".asInstanceOf[DeviceAttribute]
    @inline def MANUFACTURER = "MANUFACTURER".asInstanceOf[DeviceAttribute]
    @inline def REMOTE_ACCESS_ENABLED = "REMOTE_ACCESS_ENABLED".asInstanceOf[DeviceAttribute]
    @inline def REMOTE_DEBUG_ENABLED = "REMOTE_DEBUG_ENABLED".asInstanceOf[DeviceAttribute]
    @inline def APPIUM_VERSION = "APPIUM_VERSION".asInstanceOf[DeviceAttribute]
    @inline def INSTANCE_ARN = "INSTANCE_ARN".asInstanceOf[DeviceAttribute]
    @inline def INSTANCE_LABELS = "INSTANCE_LABELS".asInstanceOf[DeviceAttribute]
    @inline def FLEET_TYPE = "FLEET_TYPE".asInstanceOf[DeviceAttribute]
    @inline def OS_VERSION = "OS_VERSION".asInstanceOf[DeviceAttribute]
    @inline def MODEL = "MODEL".asInstanceOf[DeviceAttribute]
    @inline def AVAILABILITY = "AVAILABILITY".asInstanceOf[DeviceAttribute]
  ...
  object DeviceAvailability {
    @inline def TEMPORARY_NOT_AVAILABLE = "TEMPORARY_NOT_AVAILABLE".asInstanceOf[DeviceAvailability]
    @inline def BUSY = "BUSY".asInstanceOf[DeviceAvailability]
    @inline def AVAILABLE = "AVAILABLE".asInstanceOf[DeviceAvailability]
    @inline def HIGHLY_AVAILABLE = "HIGHLY_AVAILABLE".asInstanceOf[DeviceAvailability]
  ...
  object DeviceFilterAttribute {
    @inline def ARN = "ARN".asInstanceOf[DeviceFilterAttribute]
    @inline def PLATFORM = "PLATFORM".asInstanceOf[DeviceFilterAttribute]
    @inline def OS_VERSION = "OS_VERSION".asInstanceOf[DeviceFilterAttribute]
    @inline def MODEL = "MODEL".asInstanceOf[DeviceFilterAttribute]
    @inline def AVAILABILITY = "AVAILABILITY".asInstanceOf[DeviceFilterAttribute]
    @inline def FORM_FACTOR = "FORM_FACTOR".asInstanceOf[DeviceFilterAttribute]
    @inline def MANUFACTURER = "MANUFACTURER".asInstanceOf[DeviceFilterAttribute]
    @inline def REMOTE_ACCESS_ENABLED = "REMOTE_ACCESS_ENABLED".asInstanceOf[DeviceFilterAttribute]
    @inline def REMOTE_DEBUG_ENABLED = "REMOTE_DEBUG_ENABLED".asInstanceOf[DeviceFilterAttribute]
    @inline def INSTANCE_ARN = "INSTANCE_ARN".asInstanceOf[DeviceFilterAttribute]
    @inline def INSTANCE_LABELS = "INSTANCE_LABELS".asInstanceOf[DeviceFilterAttribute]
    @inline def FLEET_TYPE = "FLEET_TYPE".asInstanceOf[DeviceFilterAttribute]
  ...
  object DeviceFormFactor {
    @inline def PHONE = "PHONE".asInstanceOf[DeviceFormFactor]
    @inline def TABLET = "TABLET".asInstanceOf[DeviceFormFactor]
  ...
  object DevicePlatform {
    @inline def ANDROID = "ANDROID".asInstanceOf[DevicePlatform]
    @inline def IOS = "IOS".asInstanceOf[DevicePlatform]
  ...
  object DevicePoolType {
    @inline def CURATED = "CURATED".asInstanceOf[DevicePoolType]
    @inline def PRIVATE = "PRIVATE".asInstanceOf[DevicePoolType]
  ...
  object ExecutionResult {
    @inline def PENDING = "PENDING".asInstanceOf[ExecutionResult]
    @inline def PASSED = "PASSED".asInstanceOf[ExecutionResult]
    @inline def WARNED = "WARNED".asInstanceOf[ExecutionResult]
    @inline def FAILED = "FAILED".asInstanceOf[ExecutionResult]
    @inline def SKIPPED = "SKIPPED".asInstanceOf[ExecutionResult]
    @inline def ERRORED = "ERRORED".asInstanceOf[ExecutionResult]
    @inline def STOPPED = "STOPPED".asInstanceOf[ExecutionResult]
  ...
  object ExecutionResultCode {
    @inline def PARSING_FAILED = "PARSING_FAILED".asInstanceOf[ExecutionResultCode]
    @inline def VPC_ENDPOINT_SETUP_FAILED = "VPC_ENDPOINT_SETUP_FAILED".asInstanceOf[ExecutionResultCode]
  ...
  object ExecutionStatus {
    ...
    @inline def PENDING_CONCURRENCY = "PENDING_CONCURRENCY".asInstanceOf[ExecutionStatus]
    @inline def PENDING_DEVICE = "PENDING_DEVICE".asInstanceOf[ExecutionStatus]
    @inline def PROCESSING = "PROCESSING".asInstanceOf[ExecutionStatus]
    @inline def SCHEDULING = "SCHEDULING".asInstanceOf[ExecutionStatus]
    @inline def PREPARING = "PREPARING".asInstanceOf[ExecutionStatus]
  ...
  object InstanceStatus {
    @inline def IN_USE = "IN_USE".asInstanceOf[InstanceStatus]
    @inline def PREPARING = "PREPARING".asInstanceOf[InstanceStatus]
    @inline def AVAILABLE = "AVAILABLE".asInstanceOf[InstanceStatus]
    @inline def NOT_AVAILABLE = "NOT_AVAILABLE".asInstanceOf[InstanceStatus]
  ...
  object InteractionMode {
    @inline def INTERACTIVE = "INTERACTIVE".asInstanceOf[InteractionMode]
    @inline def NO_VIDEO = "NO_VIDEO".asInstanceOf[InteractionMode]
    @inline def VIDEO_ONLY = "VIDEO_ONLY".asInstanceOf[InteractionMode]
  ...
  object NetworkProfileType {
    @inline def CURATED = "CURATED".asInstanceOf[NetworkProfileType]
    @inline def PRIVATE = "PRIVATE".asInstanceOf[NetworkProfileType]
  ...
  object OfferingTransactionType {
    @inline def PURCHASE = "PURCHASE".asInstanceOf[OfferingTransactionType]
    @inline def RENEW = "RENEW".asInstanceOf[OfferingTransactionType]
    @inline def SYSTEM = "SYSTEM".asInstanceOf[OfferingTransactionType]
  ...
  object OfferingType {
    @inline def RECURRING = "RECURRING".asInstanceOf[OfferingType]
  ...
  object RecurringChargeFrequency {
    @inline def MONTHLY = "MONTHLY".asInstanceOf[RecurringChargeFrequency]
  ...
  object RuleOperator {
    @inline def EQUALS = "EQUALS".asInstanceOf[RuleOperator]
    @inline def LESS_THAN = "LESS_THAN".asInstanceOf[RuleOperator]
    @inline def LESS_THAN_OR_EQUALS = "LESS_THAN_OR_EQUALS".asInstanceOf[RuleOperator]
    @inline def GREATER_THAN = "GREATER_THAN".asInstanceOf[RuleOperator]
    @inline def GREATER_THAN_OR_EQUALS = "GREATER_THAN_OR_EQUALS".asInstanceOf[RuleOperator]
    @inline def IN = "IN".asInstanceOf[RuleOperator]
    @inline def NOT_IN = "NOT_IN".asInstanceOf[RuleOperator]
    @inline def CONTAINS = "CONTAINS".asInstanceOf[RuleOperator]
  ...
  object SampleType {
    @inline def CPU = "CPU".asInstanceOf[SampleType]
    @inline def MEMORY = "MEMORY".asInstanceOf[SampleType]
    @inline def THREADS = "THREADS".asInstanceOf[SampleType]
    @inline def RX_RATE = "RX_RATE".asInstanceOf[SampleType]
    @inline def TX_RATE = "TX_RATE".asInstanceOf[SampleType]
    @inline def RX = "RX".asInstanceOf[SampleType]
    @inline def TX = "TX".asInstanceOf[SampleType]
    @inline def NATIVE_FRAMES = "NATIVE_FRAMES".asInstanceOf[SampleType]
    @inline def NATIVE_FPS = "NATIVE_FPS".asInstanceOf[SampleType]
    @inline def NATIVE_MIN_DRAWTIME = "NATIVE_MIN_DRAWTIME".asInstanceOf[SampleType]
    @inline def NATIVE_AVG_DRAWTIME = "NATIVE_AVG_DRAWTIME".asInstanceOf[SampleType]
    @inline def NATIVE_MAX_DRAWTIME = "NATIVE_MAX_DRAWTIME".asInstanceOf[SampleType]
    @inline def OPENGL_FRAMES = "OPENGL_FRAMES".asInstanceOf[SampleType]
    @inline def OPENGL_FPS = "OPENGL_FPS".asInstanceOf[SampleType]
    @inline def OPENGL_MIN_DRAWTIME = "OPENGL_MIN_DRAWTIME".asInstanceOf[SampleType]
    @inline def OPENGL_AVG_DRAWTIME = "OPENGL_AVG_DRAWTIME".asInstanceOf[SampleType]
    @inline def OPENGL_MAX_DRAWTIME = "OPENGL_MAX_DRAWTIME".asInstanceOf[SampleType]
  ...
  object TestGridSessionArtifactCategory {
    @inline def VIDEO = "VIDEO".asInstanceOf[TestGridSessionArtifactCategory]
    @inline def LOG = "LOG".asInstanceOf[TestGridSessionArtifactCategory]
  ...
  object TestGridSessionArtifactType {
    @inline def UNKNOWN = "UNKNOWN".asInstanceOf[TestGridSessionArtifactType]
    @inline def VIDEO = "VIDEO".asInstanceOf[TestGridSessionArtifactType]
    @inline def SELENIUM_LOG = "SELENIUM_LOG".asInstanceOf[TestGridSessionArtifactType]
  ...
  object TestGridSessionStatus {
    @inline def ACTIVE = "ACTIVE".asInstanceOf[TestGridSessionStatus]
    @inline def CLOSED = "CLOSED".asInstanceOf[TestGridSessionStatus]
    @inline def ERRORED = "ERRORED".asInstanceOf[TestGridSessionStatus]
  ...
  object TestType {
    @inline def BUILTIN_FUZZ = "BUILTIN_FUZZ".asInstanceOf[TestType]
    @inline def BUILTIN_EXPLORER = "BUILTIN_EXPLORER".asInstanceOf[TestType]
    @inline def WEB_PERFORMANCE_PROFILE = "WEB_PERFORMANCE_PROFILE".asInstanceOf[TestType]
    @inline def APPIUM_JAVA_JUNIT = "APPIUM_JAVA_JUNIT".asInstanceOf[TestType]
    @inline def APPIUM_JAVA_TESTNG = "APPIUM_JAVA_TESTNG".asInstanceOf[TestType]
    @inline def APPIUM_PYTHON = "APPIUM_PYTHON".asInstanceOf[TestType]
    @inline def APPIUM_NODE = "APPIUM_NODE".asInstanceOf[TestType]
    @inline def APPIUM_RUBY = "APPIUM_RUBY".asInstanceOf[TestType]
    @inline def APPIUM_WEB_JAVA_JUNIT = "APPIUM_WEB_JAVA_JUNIT".asInstanceOf[TestType]
    @inline def APPIUM_WEB_JAVA_TESTNG = "APPIUM_WEB_JAVA_TESTNG".asInstanceOf[TestType]
    @inline def APPIUM_WEB_PYTHON = "APPIUM_WEB_PYTHON".asInstanceOf[TestType]
    @inline def APPIUM_WEB_NODE = "APPIUM_WEB_NODE".asInstanceOf[TestType]
    @inline def APPIUM_WEB_RUBY = "APPIUM_WEB_RUBY".asInstanceOf[TestType]
    @inline def CALABASH = "CALABASH".asInstanceOf[TestType]
    @inline def INSTRUMENTATION = "INSTRUMENTATION".asInstanceOf[TestType]
    @inline def UIAUTOMATION = "UIAUTOMATION".asInstanceOf[TestType]
    @inline def UIAUTOMATOR = "UIAUTOMATOR".asInstanceOf[TestType]
    @inline def XCTEST = "XCTEST".asInstanceOf[TestType]
    @inline def XCTEST_UI = "XCTEST_UI".asInstanceOf[TestType]
    @inline def REMOTE_ACCESS_RECORD = "REMOTE_ACCESS_RECORD".asInstanceOf[TestType]
    @inline def REMOTE_ACCESS_REPLAY = "REMOTE_ACCESS_REPLAY".asInstanceOf[TestType]
  ...
  object UploadCategory {
    @inline def CURATED = "CURATED".asInstanceOf[UploadCategory]
    @inline def PRIVATE = "PRIVATE".asInstanceOf[UploadCategory]
  ...
  object UploadStatus {
    @inline def INITIALIZED = "INITIALIZED".asInstanceOf[UploadStatus]
    @inline def PROCESSING = "PROCESSING".asInstanceOf[UploadStatus]
  ...
  object UploadType {
    @inline def ANDROID_APP = "ANDROID_APP".asInstanceOf[UploadType]
    @inline def IOS_APP = "IOS_APP".asInstanceOf[UploadType]
    @inline def WEB_APP = "WEB_APP".asInstanceOf[UploadType]
    @inline def EXTERNAL_DATA = "EXTERNAL_DATA".asInstanceOf[UploadType]
    @inline def APPIUM_JAVA_JUNIT_TEST_PACKAGE = "APPIUM_JAVA_JUNIT_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_JAVA_TESTNG_TEST_PACKAGE = "APPIUM_JAVA_TESTNG_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_PYTHON_TEST_PACKAGE = "APPIUM_PYTHON_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_NODE_TEST_PACKAGE = "APPIUM_NODE_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_RUBY_TEST_PACKAGE = "APPIUM_RUBY_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_JAVA_JUNIT_TEST_PACKAGE = "APPIUM_WEB_JAVA_JUNIT_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_JAVA_TESTNG_TEST_PACKAGE = "APPIUM_WEB_JAVA_TESTNG_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_PYTHON_TEST_PACKAGE = "APPIUM_WEB_PYTHON_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_NODE_TEST_PACKAGE = "APPIUM_WEB_NODE_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_RUBY_TEST_PACKAGE = "APPIUM_WEB_RUBY_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def CALABASH_TEST_PACKAGE = "CALABASH_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def INSTRUMENTATION_TEST_PACKAGE = "INSTRUMENTATION_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def UIAUTOMATION_TEST_PACKAGE = "UIAUTOMATION_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def UIAUTOMATOR_TEST_PACKAGE = "UIAUTOMATOR_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def XCTEST_TEST_PACKAGE = "XCTEST_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def XCTEST_UI_TEST_PACKAGE = "XCTEST_UI_TEST_PACKAGE".asInstanceOf[UploadType]
    @inline def APPIUM_JAVA_JUNIT_TEST_SPEC = "APPIUM_JAVA_JUNIT_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_JAVA_TESTNG_TEST_SPEC = "APPIUM_JAVA_TESTNG_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_PYTHON_TEST_SPEC = "APPIUM_PYTHON_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_NODE_TEST_SPEC = "APPIUM_NODE_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_RUBY_TEST_SPEC = "APPIUM_RUBY_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_JAVA_JUNIT_TEST_SPEC = "APPIUM_WEB_JAVA_JUNIT_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_JAVA_TESTNG_TEST_SPEC = "APPIUM_WEB_JAVA_TESTNG_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_PYTHON_TEST_SPEC = "APPIUM_WEB_PYTHON_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_NODE_TEST_SPEC = "APPIUM_WEB_NODE_TEST_SPEC".asInstanceOf[UploadType]
    @inline def APPIUM_WEB_RUBY_TEST_SPEC = "APPIUM_WEB_RUBY_TEST_SPEC".asInstanceOf[UploadType]
    @inline def INSTRUMENTATION_TEST_SPEC = "INSTRUMENTATION_TEST_SPEC".asInstanceOf[UploadType]
    @inline def XCTEST_UI_TEST_SPEC = "XCTEST_UI_TEST_SPEC".asInstanceOf[UploadType]
