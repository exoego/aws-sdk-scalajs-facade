...
package wafv2 {
  @js.native
  @JSImport("aws-sdk", "WAFV2", "AWS.WAFV2")
  ...
  object CountryCode {
    ...
    @inline def AX = "AX".asInstanceOf[CountryCode]
    ...
    @inline def BQ = "BQ".asInstanceOf[CountryCode]
    @inline def BA = "BA".asInstanceOf[CountryCode]
    @inline def BW = "BW".asInstanceOf[CountryCode]
    @inline def BV = "BV".asInstanceOf[CountryCode]
    @inline def BR = "BR".asInstanceOf[CountryCode]
    @inline def IO = "IO".asInstanceOf[CountryCode]
    ...
    @inline def CW = "CW".asInstanceOf[CountryCode]
    ...
    @inline def GF = "GF".asInstanceOf[CountryCode]
    @inline def PF = "PF".asInstanceOf[CountryCode]
    @inline def TF = "TF".asInstanceOf[CountryCode]
    ...
    @inline def GP = "GP".asInstanceOf[CountryCode]
    @inline def GU = "GU".asInstanceOf[CountryCode]
    @inline def GT = "GT".asInstanceOf[CountryCode]
    @inline def GG = "GG".asInstanceOf[CountryCode]
    ...
    @inline def HM = "HM".asInstanceOf[CountryCode]
    ...
    @inline def JE = "JE".asInstanceOf[CountryCode]
    ...
    @inline def MQ = "MQ".asInstanceOf[CountryCode]
    ...
    @inline def NF = "NF".asInstanceOf[CountryCode]
    ...
    @inline def PS = "PS".asInstanceOf[CountryCode]
    ...
    @inline def RE = "RE".asInstanceOf[CountryCode]
    ...
    @inline def SX = "SX".asInstanceOf[CountryCode]
    ...
    @inline def GS = "GS".asInstanceOf[CountryCode]
    @inline def SS = "SS".asInstanceOf[CountryCode]
    ...
    @inline def SJ = "SJ".asInstanceOf[CountryCode]
    ...
    @inline def UM = "UM".asInstanceOf[CountryCode]
    ...
    @inline def EH = "EH".asInstanceOf[CountryCode]
  ...
  object FallbackBehavior {
    @inline def MATCH = "MATCH".asInstanceOf[FallbackBehavior]
    @inline def NO_MATCH = "NO_MATCH".asInstanceOf[FallbackBehavior]
  ...
  object ForwardedIPPosition {
    @inline def FIRST = "FIRST".asInstanceOf[ForwardedIPPosition]
    @inline def LAST = "LAST".asInstanceOf[ForwardedIPPosition]
    @inline def ANY = "ANY".asInstanceOf[ForwardedIPPosition]
  ...
  object IPAddressVersion {
    @inline def IPV4 = "IPV4".asInstanceOf[IPAddressVersion]
    @inline def IPV6 = "IPV6".asInstanceOf[IPAddressVersion]
  ...
  object RateBasedStatementAggregateKeyType {
    @inline def IP = "IP".asInstanceOf[RateBasedStatementAggregateKeyType]
    @inline def FORWARDED_IP = "FORWARDED_IP".asInstanceOf[RateBasedStatementAggregateKeyType]
  ...
  object Scope {
    @inline def CLOUDFRONT = "CLOUDFRONT".asInstanceOf[Scope]
    @inline def REGIONAL = "REGIONAL".asInstanceOf[Scope]
  ...
  object TextTransformationType {
    @inline def NONE = "NONE".asInstanceOf[TextTransformationType]
    @inline def COMPRESS_WHITE_SPACE = "COMPRESS_WHITE_SPACE".asInstanceOf[TextTransformationType]
    @inline def HTML_ENTITY_DECODE = "HTML_ENTITY_DECODE".asInstanceOf[TextTransformationType]
    @inline def LOWERCASE = "LOWERCASE".asInstanceOf[TextTransformationType]
    @inline def CMD_LINE = "CMD_LINE".asInstanceOf[TextTransformationType]
    @inline def URL_DECODE = "URL_DECODE".asInstanceOf[TextTransformationType]
