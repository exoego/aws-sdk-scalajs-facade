...
package rekognition {
  ...
  object Attribute {
    @inline def DEFAULT = "DEFAULT".asInstanceOf[Attribute]
    @inline def ALL = "ALL".asInstanceOf[Attribute]
  ...
  object CelebrityRecognitionSortBy {
    @inline def ID = "ID".asInstanceOf[CelebrityRecognitionSortBy]
    @inline def TIMESTAMP = "TIMESTAMP".asInstanceOf[CelebrityRecognitionSortBy]
  ...
  object ContentModerationSortBy {
    @inline def NAME = "NAME".asInstanceOf[ContentModerationSortBy]
    @inline def TIMESTAMP = "TIMESTAMP".asInstanceOf[ContentModerationSortBy]
  ...
  object EmotionName {
    @inline def HAPPY = "HAPPY".asInstanceOf[EmotionName]
    @inline def SAD = "SAD".asInstanceOf[EmotionName]
    @inline def ANGRY = "ANGRY".asInstanceOf[EmotionName]
    @inline def CONFUSED = "CONFUSED".asInstanceOf[EmotionName]
    @inline def DISGUSTED = "DISGUSTED".asInstanceOf[EmotionName]
    @inline def SURPRISED = "SURPRISED".asInstanceOf[EmotionName]
    @inline def CALM = "CALM".asInstanceOf[EmotionName]
    @inline def UNKNOWN = "UNKNOWN".asInstanceOf[EmotionName]
    @inline def FEAR = "FEAR".asInstanceOf[EmotionName]
  ...
  object FaceAttributes {
    @inline def DEFAULT = "DEFAULT".asInstanceOf[FaceAttributes]
    @inline def ALL = "ALL".asInstanceOf[FaceAttributes]
  ...
  object FaceSearchSortBy {
    @inline def INDEX = "INDEX".asInstanceOf[FaceSearchSortBy]
    @inline def TIMESTAMP = "TIMESTAMP".asInstanceOf[FaceSearchSortBy]
  ...
  object GenderType {
    @inline def Male = "Male".asInstanceOf[GenderType]
    @inline def Female = "Female".asInstanceOf[GenderType]
  ...
  object LabelDetectionSortBy {
    @inline def NAME = "NAME".asInstanceOf[LabelDetectionSortBy]
    @inline def TIMESTAMP = "TIMESTAMP".asInstanceOf[LabelDetectionSortBy]
  ...
  object LandmarkType {
    @inline def eyeLeft = "eyeLeft".asInstanceOf[LandmarkType]
    @inline def eyeRight = "eyeRight".asInstanceOf[LandmarkType]
    @inline def nose = "nose".asInstanceOf[LandmarkType]
    @inline def mouthLeft = "mouthLeft".asInstanceOf[LandmarkType]
    @inline def mouthRight = "mouthRight".asInstanceOf[LandmarkType]
    @inline def leftEyeBrowLeft = "leftEyeBrowLeft".asInstanceOf[LandmarkType]
    @inline def leftEyeBrowRight = "leftEyeBrowRight".asInstanceOf[LandmarkType]
    @inline def leftEyeBrowUp = "leftEyeBrowUp".asInstanceOf[LandmarkType]
    @inline def rightEyeBrowLeft = "rightEyeBrowLeft".asInstanceOf[LandmarkType]
    @inline def rightEyeBrowRight = "rightEyeBrowRight".asInstanceOf[LandmarkType]
    @inline def rightEyeBrowUp = "rightEyeBrowUp".asInstanceOf[LandmarkType]
    @inline def leftEyeLeft = "leftEyeLeft".asInstanceOf[LandmarkType]
    @inline def leftEyeRight = "leftEyeRight".asInstanceOf[LandmarkType]
    @inline def leftEyeUp = "leftEyeUp".asInstanceOf[LandmarkType]
    @inline def leftEyeDown = "leftEyeDown".asInstanceOf[LandmarkType]
    @inline def rightEyeLeft = "rightEyeLeft".asInstanceOf[LandmarkType]
    @inline def rightEyeRight = "rightEyeRight".asInstanceOf[LandmarkType]
    @inline def rightEyeUp = "rightEyeUp".asInstanceOf[LandmarkType]
    @inline def rightEyeDown = "rightEyeDown".asInstanceOf[LandmarkType]
    @inline def noseLeft = "noseLeft".asInstanceOf[LandmarkType]
    @inline def noseRight = "noseRight".asInstanceOf[LandmarkType]
    @inline def mouthUp = "mouthUp".asInstanceOf[LandmarkType]
    @inline def mouthDown = "mouthDown".asInstanceOf[LandmarkType]
    @inline def leftPupil = "leftPupil".asInstanceOf[LandmarkType]
    @inline def rightPupil = "rightPupil".asInstanceOf[LandmarkType]
    @inline def upperJawlineLeft = "upperJawlineLeft".asInstanceOf[LandmarkType]
    @inline def midJawlineLeft = "midJawlineLeft".asInstanceOf[LandmarkType]
    @inline def chinBottom = "chinBottom".asInstanceOf[LandmarkType]
    @inline def midJawlineRight = "midJawlineRight".asInstanceOf[LandmarkType]
    @inline def upperJawlineRight = "upperJawlineRight".asInstanceOf[LandmarkType]
  ...
  object OrientationCorrection {
    @inline def ROTATE_0 = "ROTATE_0".asInstanceOf[OrientationCorrection]
    @inline def ROTATE_90 = "ROTATE_90".asInstanceOf[OrientationCorrection]
    @inline def ROTATE_180 = "ROTATE_180".asInstanceOf[OrientationCorrection]
    @inline def ROTATE_270 = "ROTATE_270".asInstanceOf[OrientationCorrection]
  ...
  object PersonTrackingSortBy {
    @inline def INDEX = "INDEX".asInstanceOf[PersonTrackingSortBy]
    @inline def TIMESTAMP = "TIMESTAMP".asInstanceOf[PersonTrackingSortBy]
  ...
  object ProjectStatus {
    @inline def CREATING = "CREATING".asInstanceOf[ProjectStatus]
    @inline def CREATED = "CREATED".asInstanceOf[ProjectStatus]
    @inline def DELETING = "DELETING".asInstanceOf[ProjectStatus]
  ...
  object ProjectVersionStatus {
    @inline def TRAINING_IN_PROGRESS = "TRAINING_IN_PROGRESS".asInstanceOf[ProjectVersionStatus]
    @inline def TRAINING_COMPLETED = "TRAINING_COMPLETED".asInstanceOf[ProjectVersionStatus]
    @inline def TRAINING_FAILED = "TRAINING_FAILED".asInstanceOf[ProjectVersionStatus]
    @inline def STARTING = "STARTING".asInstanceOf[ProjectVersionStatus]
    @inline def RUNNING = "RUNNING".asInstanceOf[ProjectVersionStatus]
    @inline def FAILED = "FAILED".asInstanceOf[ProjectVersionStatus]
    @inline def STOPPING = "STOPPING".asInstanceOf[ProjectVersionStatus]
    @inline def STOPPED = "STOPPED".asInstanceOf[ProjectVersionStatus]
    @inline def DELETING = "DELETING".asInstanceOf[ProjectVersionStatus]
  ...
  object QualityFilter {
    @inline def NONE = "NONE".asInstanceOf[QualityFilter]
    @inline def AUTO = "AUTO".asInstanceOf[QualityFilter]
    @inline def LOW = "LOW".asInstanceOf[QualityFilter]
    @inline def MEDIUM = "MEDIUM".asInstanceOf[QualityFilter]
    @inline def HIGH = "HIGH".asInstanceOf[QualityFilter]
  ...
  object Reason {
    @inline def EXCEEDS_MAX_FACES = "EXCEEDS_MAX_FACES".asInstanceOf[Reason]
    @inline def EXTREME_POSE = "EXTREME_POSE".asInstanceOf[Reason]
    @inline def LOW_BRIGHTNESS = "LOW_BRIGHTNESS".asInstanceOf[Reason]
    @inline def LOW_SHARPNESS = "LOW_SHARPNESS".asInstanceOf[Reason]
    @inline def LOW_CONFIDENCE = "LOW_CONFIDENCE".asInstanceOf[Reason]
    @inline def SMALL_BOUNDING_BOX = "SMALL_BOUNDING_BOX".asInstanceOf[Reason]
    @inline def LOW_FACE_QUALITY = "LOW_FACE_QUALITY".asInstanceOf[Reason]
  ...
  object SegmentType {
    @inline def TECHNICAL_CUE = "TECHNICAL_CUE".asInstanceOf[SegmentType]
    @inline def SHOT = "SHOT".asInstanceOf[SegmentType]
  ...
  object StreamProcessorStatus {
    @inline def STOPPED = "STOPPED".asInstanceOf[StreamProcessorStatus]
    @inline def STARTING = "STARTING".asInstanceOf[StreamProcessorStatus]
    @inline def RUNNING = "RUNNING".asInstanceOf[StreamProcessorStatus]
    @inline def FAILED = "FAILED".asInstanceOf[StreamProcessorStatus]
    @inline def STOPPING = "STOPPING".asInstanceOf[StreamProcessorStatus]
  ...
  object TechnicalCueType {
    @inline def ColorBars = "ColorBars".asInstanceOf[TechnicalCueType]
    @inline def EndCredits = "EndCredits".asInstanceOf[TechnicalCueType]
    @inline def BlackFrames = "BlackFrames".asInstanceOf[TechnicalCueType]
  ...
  object TextTypes {
    @inline def LINE = "LINE".asInstanceOf[TextTypes]
    @inline def WORD = "WORD".asInstanceOf[TextTypes]
  ...
  object VideoJobStatus {
    @inline def IN_PROGRESS = "IN_PROGRESS".asInstanceOf[VideoJobStatus]
    @inline def SUCCEEDED = "SUCCEEDED".asInstanceOf[VideoJobStatus]
    @inline def FAILED = "FAILED".asInstanceOf[VideoJobStatus]
