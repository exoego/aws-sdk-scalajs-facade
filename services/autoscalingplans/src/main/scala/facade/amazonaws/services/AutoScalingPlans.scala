...
package object autoscalingplans {
  ...
  def createScalingPlanFuture(params: CreateScalingPlanRequest): Future[CreateScalingPlanResponse] = service.createScalingPlan(params).promise.toFuture
  def deleteScalingPlanFuture(params: DeleteScalingPlanRequest): Future[DeleteScalingPlanResponse] = service.deleteScalingPlan(params).promise.toFuture
  def describeScalingPlanResourcesFuture(params: DescribeScalingPlanResourcesRequest): Future[DescribeScalingPlanResourcesResponse] = service.describeScalingPlanResources(params).promise.toFuture
  def describeScalingPlansFuture(params: DescribeScalingPlansRequest): Future[DescribeScalingPlansResponse] = service.describeScalingPlans(params).promise.toFuture
  def getScalingPlanResourceForecastDataFuture(params: GetScalingPlanResourceForecastDataRequest): Future[GetScalingPlanResourceForecastDataResponse] = service.getScalingPlanResourceForecastData(params).promise.toFuture
  def updateScalingPlanFuture(params: UpdateScalingPlanRequest): Future[UpdateScalingPlanResponse] = service.updateScalingPlan(params).promise.toFuture
  }
}
...
package autoscalingplans {
  ...
  object PredictiveScalingMaxCapacityBehaviorEnum {
    ...
    val values = IndexedSeq(SetForecastCapacityToMaxCapacity, SetMaxCapacityToForecastCapacity, SetMaxCapacityAboveForecastCapacity)
  }
  ...
  object ScalableDimensionEnum {
    ...
    val values = IndexedSeq(`autoscaling:autoScalingGroup:DesiredCapacity`, `ecs:service:DesiredCount`, `ec2:spot-fleet-request:TargetCapacity`, `rds:cluster:ReadReplicaCount`, `dynamodb:table:ReadCapacityUnits`, `dynamodb:table:WriteCapacityUnits`, `dynamodb:index:ReadCapacityUnits`, `dynamodb:index:WriteCapacityUnits`)
  }
  ...
  val __obj = js.Dictionary[js.Any](
    ...
    CustomizedLoadMetricSpecification.foreach(__v => __obj.update("CustomizedLoadMetricSpecification", __v.asInstanceOf[js.Any]))
    DisableDynamicScaling.foreach(__v => __obj.update("DisableDynamicScaling", __v.asInstanceOf[js.Any]))
    PredefinedLoadMetricSpecification.foreach(__v => __obj.update("PredefinedLoadMetricSpecification", __v.asInstanceOf[js.Any]))
    PredictiveScalingMaxCapacityBehavior.foreach(__v => __obj.update("PredictiveScalingMaxCapacityBehavior", __v.asInstanceOf[js.Any]))
    PredictiveScalingMaxCapacityBuffer.foreach(__v => __obj.update("PredictiveScalingMaxCapacityBuffer", __v.asInstanceOf[js.Any]))
  ...
  object ScalingPlanStatusCodeEnum {
    ...
    val values = IndexedSeq(Active, ActiveWithProblems, CreationInProgress, CreationFailed, DeletionInProgress, DeletionFailed, UpdateInProgress, UpdateFailed)
  }
  ...
  val __obj = js.Dictionary[js.Any](
    ...
    CustomizedScalingMetricSpecification.foreach(__v => __obj.update("CustomizedScalingMetricSpecification", __v.asInstanceOf[js.Any]))
    ...
    PredefinedScalingMetricSpecification.foreach(__v => __obj.update("PredefinedScalingMetricSpecification", __v.asInstanceOf[js.Any]))
