...
package sesv2 {
  ...
  object DkimSigningAttributesOrigin {
    @inline def AWS_SES = "AWS_SES".asInstanceOf[DkimSigningAttributesOrigin]
    @inline def EXTERNAL = "EXTERNAL".asInstanceOf[DkimSigningAttributesOrigin]

    @inline def values = js.Object.freeze(js.Array(AWS_SES, EXTERNAL))
  }
  ...
  object EventType {
    ...
    @inline def DELIVERY_DELAY = "DELIVERY_DELAY".asInstanceOf[EventType]

    @inline def values = js.Object.freeze(js.Array(SEND, REJECT, BOUNCE, COMPLAINT, DELIVERY, OPEN, CLICK, RENDERING_FAILURE, DELIVERY_DELAY))
  }
  ...
  object SuppressionListReason {
    @inline def BOUNCE = "BOUNCE".asInstanceOf[SuppressionListReason]
    @inline def COMPLAINT = "COMPLAINT".asInstanceOf[SuppressionListReason]

    @inline def values = js.Object.freeze(js.Array(BOUNCE, COMPLAINT))
  }
