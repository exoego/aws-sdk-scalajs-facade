...
package object sesv2 {
  ...
  implicit final class SESv2Ops(private val service: SESv2) extends AnyVal {
    ...
    @inline def deleteSuppressedDestinationFuture(
        params: DeleteSuppressedDestinationRequest
    ): Future[DeleteSuppressedDestinationResponse] = service.deleteSuppressedDestination(params).promise().toFuture
    ...
    @inline def getSuppressedDestinationFuture(
        params: GetSuppressedDestinationRequest
    ): Future[GetSuppressedDestinationResponse] = service.getSuppressedDestination(params).promise().toFuture
    ...
    @inline def listSuppressedDestinationsFuture(
        params: ListSuppressedDestinationsRequest
    ): Future[ListSuppressedDestinationsResponse] = service.listSuppressedDestinations(params).promise().toFuture
    ...
    @inline def putAccountSuppressionAttributesFuture(
        params: PutAccountSuppressionAttributesRequest
    ): Future[PutAccountSuppressionAttributesResponse] =
      service.putAccountSuppressionAttributes(params).promise().toFuture
    ...
    @inline def putConfigurationSetSuppressionOptionsFuture(
        params: PutConfigurationSetSuppressionOptionsRequest
    ): Future[PutConfigurationSetSuppressionOptionsResponse] =
      service.putConfigurationSetSuppressionOptions(params).promise().toFuture
    ...
    @inline def putEmailIdentityDkimSigningAttributesFuture(
        params: PutEmailIdentityDkimSigningAttributesRequest
    ): Future[PutEmailIdentityDkimSigningAttributesResponse] =
      service.putEmailIdentityDkimSigningAttributes(params).promise().toFuture
    ...
    @inline def putSuppressedDestinationFuture(
        params: PutSuppressedDestinationRequest
    ): Future[PutSuppressedDestinationResponse] = service.putSuppressedDestination(params).promise().toFuture
...
package sesv2 {
  ...
  class SESv2() extends js.Object {
    ...
    def putAccountSuppressionAttributes(
        params: PutAccountSuppressionAttributesRequest
    ): Request[PutAccountSuppressionAttributesResponse] = js.native
    ...
    def putEmailIdentityDkimSigningAttributes(
        params: PutEmailIdentityDkimSigningAttributesRequest
    ): Request[PutEmailIdentityDkimSigningAttributesResponse] = js.native
  ...
  object ListSuppressedDestinationsResponse {
    ...
    def apply(
      ...
      val __obj = js.Dynamic.literal()
      NextToken.foreach(__v => __obj.updateDynamic("NextToken")(__v.asInstanceOf[js.Any]))
      SuppressedDestinationSummaries.foreach(__v =>
        __obj.updateDynamic("SuppressedDestinationSummaries")(__v.asInstanceOf[js.Any])
      )
