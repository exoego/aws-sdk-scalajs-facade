...
package appsync {
  ...
  object ApiCacheStatus {
    @inline def AVAILABLE = "AVAILABLE".asInstanceOf[ApiCacheStatus]
    @inline def CREATING = "CREATING".asInstanceOf[ApiCacheStatus]
    @inline def DELETING = "DELETING".asInstanceOf[ApiCacheStatus]
    @inline def MODIFYING = "MODIFYING".asInstanceOf[ApiCacheStatus]
    @inline def FAILED = "FAILED".asInstanceOf[ApiCacheStatus]
  ...
  object ApiCacheType {
    @inline def T2_SMALL = "T2_SMALL".asInstanceOf[ApiCacheType]
    @inline def T2_MEDIUM = "T2_MEDIUM".asInstanceOf[ApiCacheType]
    @inline def R4_LARGE = "R4_LARGE".asInstanceOf[ApiCacheType]
    @inline def R4_XLARGE = "R4_XLARGE".asInstanceOf[ApiCacheType]
    @inline def R4_2XLARGE = "R4_2XLARGE".asInstanceOf[ApiCacheType]
    @inline def R4_4XLARGE = "R4_4XLARGE".asInstanceOf[ApiCacheType]
    @inline def R4_8XLARGE = "R4_8XLARGE".asInstanceOf[ApiCacheType]
    @inline def SMALL = "SMALL".asInstanceOf[ApiCacheType]
    @inline def MEDIUM = "MEDIUM".asInstanceOf[ApiCacheType]
    @inline def LARGE = "LARGE".asInstanceOf[ApiCacheType]
    @inline def XLARGE = "XLARGE".asInstanceOf[ApiCacheType]
    @inline def LARGE_2X = "LARGE_2X".asInstanceOf[ApiCacheType]
    @inline def LARGE_4X = "LARGE_4X".asInstanceOf[ApiCacheType]
    @inline def LARGE_8X = "LARGE_8X".asInstanceOf[ApiCacheType]
    @inline def LARGE_12X = "LARGE_12X".asInstanceOf[ApiCacheType]
  ...
  object ApiCachingBehavior {
    @inline def FULL_REQUEST_CACHING = "FULL_REQUEST_CACHING".asInstanceOf[ApiCachingBehavior]
    @inline def PER_RESOLVER_CACHING = "PER_RESOLVER_CACHING".asInstanceOf[ApiCachingBehavior]
  ...
  object AuthenticationType {
    @inline def API_KEY = "API_KEY".asInstanceOf[AuthenticationType]
    @inline def AWS_IAM = "AWS_IAM".asInstanceOf[AuthenticationType]
    @inline def AMAZON_COGNITO_USER_POOLS = "AMAZON_COGNITO_USER_POOLS".asInstanceOf[AuthenticationType]
    @inline def OPENID_CONNECT = "OPENID_CONNECT".asInstanceOf[AuthenticationType]
  ...
  object ConflictDetectionType {
    @inline def VERSION = "VERSION".asInstanceOf[ConflictDetectionType]
    @inline def NONE = "NONE".asInstanceOf[ConflictDetectionType]
  ...
  object ConflictHandlerType {
    @inline def OPTIMISTIC_CONCURRENCY = "OPTIMISTIC_CONCURRENCY".asInstanceOf[ConflictHandlerType]
    @inline def LAMBDA = "LAMBDA".asInstanceOf[ConflictHandlerType]
    @inline def AUTOMERGE = "AUTOMERGE".asInstanceOf[ConflictHandlerType]
    @inline def NONE = "NONE".asInstanceOf[ConflictHandlerType]
  ...
  object DataSourceType {
    @inline def AWS_LAMBDA = "AWS_LAMBDA".asInstanceOf[DataSourceType]
    @inline def AMAZON_DYNAMODB = "AMAZON_DYNAMODB".asInstanceOf[DataSourceType]
    @inline def AMAZON_ELASTICSEARCH = "AMAZON_ELASTICSEARCH".asInstanceOf[DataSourceType]
    @inline def NONE = "NONE".asInstanceOf[DataSourceType]
    @inline def HTTP = "HTTP".asInstanceOf[DataSourceType]
    @inline def RELATIONAL_DATABASE = "RELATIONAL_DATABASE".asInstanceOf[DataSourceType]
  ...
  object DefaultAction {
    @inline def ALLOW = "ALLOW".asInstanceOf[DefaultAction]
    @inline def DENY = "DENY".asInstanceOf[DefaultAction]
  ...
  object FieldLogLevel {
    @inline def NONE = "NONE".asInstanceOf[FieldLogLevel]
    @inline def ERROR = "ERROR".asInstanceOf[FieldLogLevel]
    @inline def ALL = "ALL".asInstanceOf[FieldLogLevel]
  ...
  object OutputType {
    @inline def SDL = "SDL".asInstanceOf[OutputType]
    @inline def JSON = "JSON".asInstanceOf[OutputType]
  ...
  object RelationalDatabaseSourceType {
    @inline def RDS_HTTP_ENDPOINT = "RDS_HTTP_ENDPOINT".asInstanceOf[RelationalDatabaseSourceType]
  ...
  object ResolverKind {
    @inline def UNIT = "UNIT".asInstanceOf[ResolverKind]
    @inline def PIPELINE = "PIPELINE".asInstanceOf[ResolverKind]
  ...
  object SchemaStatus {
    @inline def PROCESSING = "PROCESSING".asInstanceOf[SchemaStatus]
    @inline def ACTIVE = "ACTIVE".asInstanceOf[SchemaStatus]
    @inline def DELETING = "DELETING".asInstanceOf[SchemaStatus]
    @inline def FAILED = "FAILED".asInstanceOf[SchemaStatus]
    @inline def SUCCESS = "SUCCESS".asInstanceOf[SchemaStatus]
    @inline def NOT_APPLICABLE = "NOT_APPLICABLE".asInstanceOf[SchemaStatus]
  ...
  object TypeDefinitionFormat {
    @inline def SDL = "SDL".asInstanceOf[TypeDefinitionFormat]
    @inline def JSON = "JSON".asInstanceOf[TypeDefinitionFormat]
