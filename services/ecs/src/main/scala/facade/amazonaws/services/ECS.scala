...
package ecs {
  ...
  object AgentUpdateStatus {
    @inline def PENDING = "PENDING".asInstanceOf[AgentUpdateStatus]
    @inline def STAGING = "STAGING".asInstanceOf[AgentUpdateStatus]
    @inline def STAGED = "STAGED".asInstanceOf[AgentUpdateStatus]
    @inline def UPDATING = "UPDATING".asInstanceOf[AgentUpdateStatus]
    @inline def UPDATED = "UPDATED".asInstanceOf[AgentUpdateStatus]
    @inline def FAILED = "FAILED".asInstanceOf[AgentUpdateStatus]

    @inline def values = js.Object.freeze(js.Array(PENDING, STAGING, STAGED, UPDATING, UPDATED, FAILED))
  }
  ...
  object CapacityProviderField {
    @inline def TAGS = "TAGS".asInstanceOf[CapacityProviderField]

    @inline def values = js.Object.freeze(js.Array(TAGS))
  }

  @js.native
  sealed trait CapacityProviderStatus extends js.Any
  object CapacityProviderStatus {
    @inline def ACTIVE = "ACTIVE".asInstanceOf[CapacityProviderStatus]
    @inline def INACTIVE = "INACTIVE".asInstanceOf[CapacityProviderStatus]
  ...
  object CapacityProviderUpdateStatus {
    @inline def DELETE_IN_PROGRESS = "DELETE_IN_PROGRESS".asInstanceOf[CapacityProviderUpdateStatus]
    @inline def DELETE_COMPLETE = "DELETE_COMPLETE".asInstanceOf[CapacityProviderUpdateStatus]
    @inline def DELETE_FAILED = "DELETE_FAILED".asInstanceOf[CapacityProviderUpdateStatus]

    @inline def values = js.Object.freeze(js.Array(DELETE_IN_PROGRESS, DELETE_COMPLETE, DELETE_FAILED))
  }
  ...
  object ClusterField {
    @inline def ATTACHMENTS = "ATTACHMENTS".asInstanceOf[ClusterField]
    @inline def SETTINGS = "SETTINGS".asInstanceOf[ClusterField]
    @inline def STATISTICS = "STATISTICS".asInstanceOf[ClusterField]
    @inline def TAGS = "TAGS".asInstanceOf[ClusterField]

    @inline def values = js.Object.freeze(js.Array(ATTACHMENTS, SETTINGS, STATISTICS, TAGS))
  }
  ...
  object ClusterSettingName {
    @inline def containerInsights = "containerInsights".asInstanceOf[ClusterSettingName]

    @inline def values = js.Object.freeze(js.Array(containerInsights))
  }

  @js.native
  sealed trait Compatibility extends js.Any
  object Compatibility {
    @inline def EC2 = "EC2".asInstanceOf[Compatibility]
    @inline def FARGATE = "FARGATE".asInstanceOf[Compatibility]
  ...
  object Connectivity {
    @inline def CONNECTED = "CONNECTED".asInstanceOf[Connectivity]
    @inline def DISCONNECTED = "DISCONNECTED".asInstanceOf[Connectivity]
  ...
  object ContainerCondition {
    @inline def START = "START".asInstanceOf[ContainerCondition]
    @inline def COMPLETE = "COMPLETE".asInstanceOf[ContainerCondition]
    @inline def SUCCESS = "SUCCESS".asInstanceOf[ContainerCondition]
    @inline def HEALTHY = "HEALTHY".asInstanceOf[ContainerCondition]

    @inline def values = js.Object.freeze(js.Array(START, COMPLETE, SUCCESS, HEALTHY))
  }
  ...
  object ContainerInstanceField {
    @inline def TAGS = "TAGS".asInstanceOf[ContainerInstanceField]
  ...
  object ContainerInstanceStatus {
    @inline def ACTIVE = "ACTIVE".asInstanceOf[ContainerInstanceStatus]
    @inline def DRAINING = "DRAINING".asInstanceOf[ContainerInstanceStatus]
    @inline def REGISTERING = "REGISTERING".asInstanceOf[ContainerInstanceStatus]
    @inline def DEREGISTERING = "DEREGISTERING".asInstanceOf[ContainerInstanceStatus]
    @inline def REGISTRATION_FAILED = "REGISTRATION_FAILED".asInstanceOf[ContainerInstanceStatus]

    @inline def values = js.Object.freeze(js.Array(ACTIVE, DRAINING, REGISTERING, DEREGISTERING, REGISTRATION_FAILED))
  }
  ...
  object DeploymentControllerType {
    @inline def ECS = "ECS".asInstanceOf[DeploymentControllerType]
    @inline def CODE_DEPLOY = "CODE_DEPLOY".asInstanceOf[DeploymentControllerType]
    @inline def EXTERNAL = "EXTERNAL".asInstanceOf[DeploymentControllerType]

    @inline def values = js.Object.freeze(js.Array(ECS, CODE_DEPLOY, EXTERNAL))
  }
  ...
  object DesiredStatus {
    @inline def RUNNING = "RUNNING".asInstanceOf[DesiredStatus]
    @inline def PENDING = "PENDING".asInstanceOf[DesiredStatus]
    @inline def STOPPED = "STOPPED".asInstanceOf[DesiredStatus]

    @inline def values = js.Object.freeze(js.Array(RUNNING, PENDING, STOPPED))
  }
  ...
  object EFSAuthorizationConfigIAM {
    @inline def ENABLED = "ENABLED".asInstanceOf[EFSAuthorizationConfigIAM]
    @inline def DISABLED = "DISABLED".asInstanceOf[EFSAuthorizationConfigIAM]
  ...
  object EFSTransitEncryption {
    @inline def ENABLED = "ENABLED".asInstanceOf[EFSTransitEncryption]
    @inline def DISABLED = "DISABLED".asInstanceOf[EFSTransitEncryption]
  ...
  object EnvironmentFileType {
    @inline def s3 = "s3".asInstanceOf[EnvironmentFileType]
  ...
  object FirelensConfigurationType {
    @inline def fluentd = "fluentd".asInstanceOf[FirelensConfigurationType]
    @inline def fluentbit = "fluentbit".asInstanceOf[FirelensConfigurationType]

    @inline def values = js.Object.freeze(js.Array(fluentd, fluentbit))
  }
  ...
  object IpcMode {
    @inline def host = "host".asInstanceOf[IpcMode]
    @inline def task = "task".asInstanceOf[IpcMode]
    @inline def none = "none".asInstanceOf[IpcMode]

    @inline def values = js.Object.freeze(js.Array(host, task, none))
  }
  ...
  object LogDriver {
    @inline def `json-file` = "json-file".asInstanceOf[LogDriver]
    @inline def syslog = "syslog".asInstanceOf[LogDriver]
    @inline def journald = "journald".asInstanceOf[LogDriver]
    @inline def gelf = "gelf".asInstanceOf[LogDriver]
    @inline def fluentd = "fluentd".asInstanceOf[LogDriver]
    @inline def awslogs = "awslogs".asInstanceOf[LogDriver]
    @inline def splunk = "splunk".asInstanceOf[LogDriver]
    @inline def awsfirelens = "awsfirelens".asInstanceOf[LogDriver]

    @inline def values = js.Object.freeze(js.Array(`json-file`, syslog, journald, gelf, fluentd, awslogs, splunk, awsfirelens))
  }
  ...
  object ManagedScalingStatus {
    @inline def ENABLED = "ENABLED".asInstanceOf[ManagedScalingStatus]
    @inline def DISABLED = "DISABLED".asInstanceOf[ManagedScalingStatus]
  ...
  object ManagedTerminationProtection {
    @inline def ENABLED = "ENABLED".asInstanceOf[ManagedTerminationProtection]
    @inline def DISABLED = "DISABLED".asInstanceOf[ManagedTerminationProtection]
  ...
  object NetworkMode {
    @inline def bridge = "bridge".asInstanceOf[NetworkMode]
    @inline def host = "host".asInstanceOf[NetworkMode]
    @inline def awsvpc = "awsvpc".asInstanceOf[NetworkMode]
    @inline def none = "none".asInstanceOf[NetworkMode]

    @inline def values = js.Object.freeze(js.Array(bridge, host, awsvpc, none))
  }

  @js.native
  sealed trait PidMode extends js.Any
  object PidMode {
    @inline def host = "host".asInstanceOf[PidMode]
    @inline def task = "task".asInstanceOf[PidMode]

    @inline def values = js.Object.freeze(js.Array(host, task))
  }
  ...
  object PlacementConstraintType {
    @inline def distinctInstance = "distinctInstance".asInstanceOf[PlacementConstraintType]
    @inline def memberOf = "memberOf".asInstanceOf[PlacementConstraintType]

    @inline def values = js.Object.freeze(js.Array(distinctInstance, memberOf))
  }
  ...
  object PlacementStrategyType {
    @inline def random = "random".asInstanceOf[PlacementStrategyType]
    @inline def spread = "spread".asInstanceOf[PlacementStrategyType]
    @inline def binpack = "binpack".asInstanceOf[PlacementStrategyType]

    @inline def values = js.Object.freeze(js.Array(random, spread, binpack))
  }
  ...
  object PlatformDeviceType {
    @inline def GPU = "GPU".asInstanceOf[PlatformDeviceType]
  ...
  object PropagateTags {
    @inline def TASK_DEFINITION = "TASK_DEFINITION".asInstanceOf[PropagateTags]
    @inline def SERVICE = "SERVICE".asInstanceOf[PropagateTags]

    @inline def values = js.Object.freeze(js.Array(TASK_DEFINITION, SERVICE))
  }
  ...
  object ProxyConfigurationType {
    @inline def APPMESH = "APPMESH".asInstanceOf[ProxyConfigurationType]

    @inline def values = js.Object.freeze(js.Array(APPMESH))
  }
  ...
  object ResourceType {
    ...
    @inline def InferenceAccelerator = "InferenceAccelerator".asInstanceOf[ResourceType]

    @inline def values = js.Object.freeze(js.Array(GPU, InferenceAccelerator))
  }
  ...
  object ScaleUnit {
    @inline def PERCENT = "PERCENT".asInstanceOf[ScaleUnit]

    @inline def values = js.Object.freeze(js.Array(PERCENT))
  }

  @js.native
  sealed trait SchedulingStrategy extends js.Any
  object SchedulingStrategy {
    @inline def REPLICA = "REPLICA".asInstanceOf[SchedulingStrategy]
    @inline def DAEMON = "DAEMON".asInstanceOf[SchedulingStrategy]

    @inline def values = js.Object.freeze(js.Array(REPLICA, DAEMON))
  }

  @js.native
  sealed trait Scope extends js.Any
  object Scope {
    @inline def task = "task".asInstanceOf[Scope]
    @inline def shared = "shared".asInstanceOf[Scope]

    @inline def values = js.Object.freeze(js.Array(task, shared))
  }
  ...
  object ServiceField {
    @inline def TAGS = "TAGS".asInstanceOf[ServiceField]
  ...
  object SettingName {
    @inline def serviceLongArnFormat = "serviceLongArnFormat".asInstanceOf[SettingName]
    @inline def taskLongArnFormat = "taskLongArnFormat".asInstanceOf[SettingName]
    @inline def containerInstanceLongArnFormat = "containerInstanceLongArnFormat".asInstanceOf[SettingName]
    @inline def awsvpcTrunking = "awsvpcTrunking".asInstanceOf[SettingName]
    @inline def containerInsights = "containerInsights".asInstanceOf[SettingName]

    @inline def values = js.Object.freeze(js.Array(serviceLongArnFormat, taskLongArnFormat, containerInstanceLongArnFormat, awsvpcTrunking, containerInsights))
  }
  ...
  object StabilityStatus {
    @inline def STEADY_STATE = "STEADY_STATE".asInstanceOf[StabilityStatus]
    @inline def STABILIZING = "STABILIZING".asInstanceOf[StabilityStatus]

    @inline def values = js.Object.freeze(js.Array(STEADY_STATE, STABILIZING))
  }
  ...
  object TargetType {
    @inline def `container-instance` = "container-instance".asInstanceOf[TargetType]

    @inline def values = js.Object.freeze(js.Array(`container-instance`))
  }
  ...
  object TaskDefinitionFamilyStatus {
    @inline def ACTIVE = "ACTIVE".asInstanceOf[TaskDefinitionFamilyStatus]
    @inline def INACTIVE = "INACTIVE".asInstanceOf[TaskDefinitionFamilyStatus]
    @inline def ALL = "ALL".asInstanceOf[TaskDefinitionFamilyStatus]

    @inline def values = js.Object.freeze(js.Array(ACTIVE, INACTIVE, ALL))
  }

  @js.native
  sealed trait TaskDefinitionField extends js.Any
  object TaskDefinitionField {
    @inline def TAGS = "TAGS".asInstanceOf[TaskDefinitionField]
  ...
  object TaskDefinitionPlacementConstraintType {
    @inline def memberOf = "memberOf".asInstanceOf[TaskDefinitionPlacementConstraintType]

    @inline def values = js.Object.freeze(js.Array(memberOf))
  }

  @js.native
  sealed trait TaskDefinitionStatus extends js.Any
  object TaskDefinitionStatus {
    @inline def ACTIVE = "ACTIVE".asInstanceOf[TaskDefinitionStatus]
    @inline def INACTIVE = "INACTIVE".asInstanceOf[TaskDefinitionStatus]
  ...
  object TaskField {
    @inline def TAGS = "TAGS".asInstanceOf[TaskField]
  ...
  object TaskSetField {
    @inline def TAGS = "TAGS".asInstanceOf[TaskSetField]
  ...
  object TaskStopCode {
    @inline def TaskFailedToStart = "TaskFailedToStart".asInstanceOf[TaskStopCode]
    @inline def EssentialContainerExited = "EssentialContainerExited".asInstanceOf[TaskStopCode]
    @inline def UserInitiated = "UserInitiated".asInstanceOf[TaskStopCode]

    @inline def values = js.Object.freeze(js.Array(TaskFailedToStart, EssentialContainerExited, UserInitiated))
  }
  ...
  object TransportProtocol {
    @inline def tcp = "tcp".asInstanceOf[TransportProtocol]
    @inline def udp = "udp".asInstanceOf[TransportProtocol]
  ...
  object UlimitName {
    @inline def core = "core".asInstanceOf[UlimitName]
    @inline def cpu = "cpu".asInstanceOf[UlimitName]
    @inline def data = "data".asInstanceOf[UlimitName]
    @inline def fsize = "fsize".asInstanceOf[UlimitName]
    @inline def locks = "locks".asInstanceOf[UlimitName]
    @inline def memlock = "memlock".asInstanceOf[UlimitName]
    @inline def msgqueue = "msgqueue".asInstanceOf[UlimitName]
    @inline def nice = "nice".asInstanceOf[UlimitName]
    @inline def nofile = "nofile".asInstanceOf[UlimitName]
    @inline def nproc = "nproc".asInstanceOf[UlimitName]
    @inline def rss = "rss".asInstanceOf[UlimitName]
    @inline def rtprio = "rtprio".asInstanceOf[UlimitName]
    @inline def rttime = "rttime".asInstanceOf[UlimitName]
    @inline def sigpending = "sigpending".asInstanceOf[UlimitName]
    @inline def stack = "stack".asInstanceOf[UlimitName]

    @inline def values = js.Object.freeze(js.Array(core, cpu, data, fsize, locks, memlock, msgqueue, nice, nofile, nproc, rss, rtprio, rttime, sigpending, stack))
  }
