...
class AWSConfig(
  ...
  var hostPrefixEnabled: js.UndefOr[Boolean] = js.undefined) extends js.Object
...
class HttpOptions(
  ...
  var xhrWithCredentials: js.UndefOr[Boolean] = js.undefined) extends js.Object
...
class ParamValidation(
  ...
  var enum: js.UndefOr[Boolean] = js.undefined) extends js.Object
...
class RetryDelayOptions(
  ...
  var customBackoff: js.UndefOr[Double => Double] = js.undefined) extends js.Object

object RetryDelayOptions {
  def apply(
    base: js.UndefOr[Double] = js.undefined,
    customBackoff: js.UndefOr[Double => Double] = js.undefined): RetryDelayOptions = new RetryDelayOptions(base, customBackoff)
}