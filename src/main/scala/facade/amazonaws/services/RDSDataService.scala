...
package rdsdataservice {
  ...
  object Record {
    def apply(
      values: js.UndefOr[Row] = js.undefined): Record = {
      val _fields = IndexedSeq[(String, js.Any)](
  ...
  object ResultSetMetadata {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "columnCount" -> columnCount.map { x => x.asInstanceOf[js.Any] },
        "columnMetadata" -> columnMetadata.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object SqlStatementResult {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "numberOfRecordsUpdated" -> numberOfRecordsUpdated.map { x => x.asInstanceOf[js.Any] },
        "resultFrame" -> resultFrame.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object StructValue {
    def apply(
      attributes: js.UndefOr[ArrayValues] = js.undefined): StructValue = {
      val _fields = IndexedSeq[(String, js.Any)](
