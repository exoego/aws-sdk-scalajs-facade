...
package pinpointsmsvoice {
  ...
  object CallInstructionsMessageType {
    def apply(
      Text: js.UndefOr[NonEmptyString] = js.undefined): CallInstructionsMessageType = {
  ...
  object CloudWatchLogsDestination {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        ...
        "LogGroupArn" -> LogGroupArn.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object CreateConfigurationSetRequest {
    def apply(
      ConfigurationSetName: js.UndefOr[WordCharactersWithDelimiters] = js.undefined): CreateConfigurationSetRequest = {
      val _fields = IndexedSeq[(String, js.Any)](
  ...
  object SendVoiceMessageResponse {
    def apply(
      MessageId: js.UndefOr[String] = js.undefined): SendVoiceMessageResponse = {
      val _fields = IndexedSeq[(String, js.Any)](
  ...
  object VoiceMessageContent {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "CallInstructionsMessage" -> CallInstructionsMessage.map { x => x.asInstanceOf[js.Any] },
        "PlainTextMessage" -> PlainTextMessage.map { x => x.asInstanceOf[js.Any] },
        "SSMLMessage" -> SSMLMessage.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
