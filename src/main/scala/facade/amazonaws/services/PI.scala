...
package pi {
  ...
  object DescribeDimensionKeysRequest {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        ...
        "PeriodInSeconds" -> PeriodInSeconds.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object DescribeDimensionKeysResponse {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        ...
        "NextToken" -> NextToken.map { x => x.asInstanceOf[js.Any] },
        "PartitionKeys" -> PartitionKeys.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object MetricQuery {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "Metric" -> Metric.asInstanceOf[js.Any],
        "Filter" -> Filter.map { x => x.asInstanceOf[js.Any] },
        "GroupBy" -> GroupBy.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object ResponsePartitionKey {
    def apply(
      Dimensions: DimensionMap): ResponsePartitionKey = {
      val _fields = IndexedSeq[(String, js.Any)](
        "Dimensions" -> Dimensions.asInstanceOf[js.Any]).filter(_._2 != (js.undefined: js.Any))
