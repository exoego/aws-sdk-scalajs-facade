...
package simpledb {
  ...
  object GetAttributesResult {
    def apply(
      Attributes: js.UndefOr[AttributeList] = js.undefined): GetAttributesResult = {
      val _fields = IndexedSeq[(String, js.Any)](
        "Attributes" -> Attributes.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
  ...
  object ListDomainsRequest {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "MaxNumberOfDomains" -> MaxNumberOfDomains.map { x => x.asInstanceOf[js.Any] },
  ...
  object ListDomainsResult {
    def apply(
      ...
      val _fields = IndexedSeq[(String, js.Any)](
        "DomainNames" -> DomainNames.map { x => x.asInstanceOf[js.Any] },
        "NextToken" -> NextToken.map { x => x.asInstanceOf[js.Any] }).filter(_._2 != (js.undefined: js.Any))
