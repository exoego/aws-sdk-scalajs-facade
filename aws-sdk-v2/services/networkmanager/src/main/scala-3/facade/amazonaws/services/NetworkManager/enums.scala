...
type AttachmentType = "CONNECT" | "SITE_TO_SITE_VPN" | "VPC" | "TRANSIT_GATEWAY_ROUTE_TABLE"
...
type ChangeStatus = "NOT_STARTED" | "IN_PROGRESS" | "COMPLETE" | "FAILED"
object ChangeStatus {
...
type ChangeType = "CORE_NETWORK_SEGMENT" | "CORE_NETWORK_EDGE" | "ATTACHMENT_MAPPING" | "ATTACHMENT_ROUTE_PROPAGATION" | "ATTACHMENT_ROUTE_STATIC" | "CORE_NETWORK_CONFIGURATION" | "SEGMENTS_CONFIGURATION" | "SEGMENT_ACTIONS_CONFIGURATION" | "ATTACHMENT_POLICIES_CONFIGURATION"
object ChangeType {
  ...
  inline val CORE_NETWORK_CONFIGURATION: "CORE_NETWORK_CONFIGURATION" = "CORE_NETWORK_CONFIGURATION"
  inline val SEGMENTS_CONFIGURATION: "SEGMENTS_CONFIGURATION" = "SEGMENTS_CONFIGURATION"
  inline val SEGMENT_ACTIONS_CONFIGURATION: "SEGMENT_ACTIONS_CONFIGURATION" = "SEGMENT_ACTIONS_CONFIGURATION"
  inline val ATTACHMENT_POLICIES_CONFIGURATION: "ATTACHMENT_POLICIES_CONFIGURATION" = "ATTACHMENT_POLICIES_CONFIGURATION"
...
type PeeringState = "CREATING" | "FAILED" | "AVAILABLE" | "DELETING"
object PeeringState {
  inline val CREATING: "CREATING" = "CREATING"
  inline val FAILED: "FAILED" = "FAILED"
  inline val AVAILABLE: "AVAILABLE" = "AVAILABLE"
...
type PeeringType = "TRANSIT_GATEWAY"
object PeeringType {
