...
package object elasticinference {
  ...
  final class ElasticInferenceOps(private val service: ElasticInference) extends AnyVal {
  ...
  object ElasticInference {
    @inline implicit def toOps(service: ElasticInference): ElasticInferenceOps = {
      new ElasticInferenceOps(service)
    }
  }
