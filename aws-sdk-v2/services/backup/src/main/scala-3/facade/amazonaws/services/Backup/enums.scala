...
type BackupJobState = "CREATED" | "PENDING" | "RUNNING" | "ABORTING" | "ABORTED" | "COMPLETED" | "FAILED" | "EXPIRED" | "PARTIAL"
...
object BackupVaultEvent {
  ...
  inline val S3_BACKUP_OBJECT_FAILED: "S3_BACKUP_OBJECT_FAILED" = "S3_BACKUP_OBJECT_FAILED"
  inline val S3_RESTORE_OBJECT_FAILED: "S3_RESTORE_OBJECT_FAILED" = "S3_RESTORE_OBJECT_FAILED"
...
type CopyJobState = "CREATED" | "RUNNING" | "COMPLETED" | "FAILED" | "PARTIAL"
object CopyJobState {
  inline val CREATED: "CREATED" = "CREATED"
  inline val RUNNING: "RUNNING" = "RUNNING"
  inline val COMPLETED: "COMPLETED" = "COMPLETED"
...
type LegalHoldStatus = "CREATING" | "ACTIVE" | "CANCELING" | "CANCELED"
