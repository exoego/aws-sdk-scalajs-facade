...
/** The broker's status.
  */
type BrokerState = "CREATION_IN_PROGRESS" | "CREATION_FAILED" | "DELETION_IN_PROGRESS" | "RUNNING" | "REBOOT_IN_PROGRESS" | "CRITICAL_ACTION_REQUIRED"
object BrokerState {
  ...
  inline val CRITICAL_ACTION_REQUIRED: "CRITICAL_ACTION_REQUIRED" = "CRITICAL_ACTION_REQUIRED"
