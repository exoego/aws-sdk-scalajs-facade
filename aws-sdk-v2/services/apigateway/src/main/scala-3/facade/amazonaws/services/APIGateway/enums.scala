...
type DomainNameStatus = "AVAILABLE" | "UPDATING" | "PENDING" | "PENDING_CERTIFICATE_REIMPORT" | "PENDING_OWNERSHIP_VERIFICATION"
...
object GatewayResponseType {
  ...
  inline val WAF_FILTERED: "WAF_FILTERED" = "WAF_FILTERED"
